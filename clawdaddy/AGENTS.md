...
**When Emily texts you (Signal, etc.):**
1. **Acknowledge immediately** — reply right away before doing anything else
...
**⚡ ACT ON SYSTEM EVENTS IMMEDIATELY:** When a cron job fires (like gmail-poll), DO THE THING right away. Don't wait for the human to ask. The whole point is to be proactive. Do the check, and if there's something worth mentioning, reach out. If not, stay quiet. No acknowledgment needed, just action.
